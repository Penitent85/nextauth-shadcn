...
CREATE TABLE `User` (
    ...
    `isTowFactorEnabled` BOOLEAN NOT NULL DEFAULT false,
...
-- CreateTable
CREATE TABLE `TowFactorToken` (
    `id` VARCHAR(191) NOT NULL,
    `email` VARCHAR(191) NOT NULL,
    `token` VARCHAR(191) NOT NULL,
    `expires` DATETIME(3) NOT NULL,

    UNIQUE INDEX `TowFactorToken_token_key`(`token`),
    UNIQUE INDEX `TowFactorToken_email_token_key`(`email`, `token`),
    PRIMARY KEY (`id`)
) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;
...
CREATE TABLE `TwoFactorConformation` (
    ...
    UNIQUE INDEX `TwoFactorConformation_userId_key`(`userId`),
    PRIMARY KEY (`id`)
) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;
